...
span_set <- c((1000000/Resolution)*4, (1000000/Resolution)*5, (1000000/Resolution)*6, (1000000/Resolution)*7)
...
for (fold in 1:fold_count) {
  ...
  for (span_size in span_set) {
    ...
    trained_set <- loess_train(X_train , anchor, span_frac)
...
interactions_table <- loess_train(X_train , anchor, span_frac)
