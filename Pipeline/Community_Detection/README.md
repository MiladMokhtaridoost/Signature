...
Please execute the following three steps in the mentioned order. First two steps are for preparing Hi-C data for CD in a netwrok format, and the final script is for applying CD.
